import zoom from '../assets/svg/projects/zoom.png'

export const blogData = [
    {
        id: 1,
        title: 'Zoom: Cultivating Human Connection in a Digital World',
        description: 'Building relationships online through trust, humor, and love.',
        date: 'Aug 7, 2020',
        image: zoom,
        url: 'https://shashankkurakula.blogspot.com/2023/06/title-zoom-revolutionizing-human.html'
    },
    // {
    //     id: 2,
